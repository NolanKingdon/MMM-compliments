...
The `compliments` module is one of the default modules of the MagicMirror. This is a copy of that module, with additional support for being able to receive the `COMPLIMENT_CONTEXT` from third party modules.
...
```
cd modules
git clone https://github.com/NolanKingdon/MMM-compliments
```
...
This copy of the compliments module also allows for the `COMPLIMENT_CONTEXT` notification to be sent. 
This functions very similarly to the weather mentioned above. See third party module READMEs for potential values. 
...
#### Example use with third party payload:

```javascript
config: {
    compliments: {
        moonphase: {
            full: [ "The moon tonight is as bright as your future!" ],
            new: [ "You don't need a moon - your smile will light the night!" ]
        }
    }
}
```
